			...
			if ($_POST["persistformvar"] != "true") {
				...
				if (is_array($array) && @sizeof($array) != 0) {
					...
					//add common array elements
						...
						$array['music_on_hold'][0]['music_on_hold_rate'] = !empty($music_on_hold_rate) ? $music_on_hold_rate : null;
						$array['music_on_hold'][0]['music_on_hold_shuffle'] = $music_on_hold_shuffle;
						$array['music_on_hold'][0]['music_on_hold_channels'] = !empty($music_on_hold_channels) ? $music_on_hold_channels : null;
						$array['music_on_hold'][0]['music_on_hold_interval'] = !empty($music_on_hold_interval) ? $music_on_hold_interval : null;
						...
						$array['music_on_hold'][0]['music_on_hold_chime_freq'] = !empty($music_on_hold_chime_freq) ? $music_on_hold_chime_freq : null;
						$array['music_on_hold'][0]['music_on_hold_chime_max'] = !empty($music_on_hold_chime_max) ? $music_on_hold_chime_max : null;
