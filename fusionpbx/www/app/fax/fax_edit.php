				...
				if (is_array($array) && @sizeof($array) != 0) {
					//add common columns to array
						...
						if (permission_exists('fax_send_greeting')) {
							$array['fax'][0]['fax_send_greeting'] = !empty($fax_send_greeting) ? $fax_send_greeting : null;
						}
						$array['fax'][0]['fax_send_channels'] = !empty($fax_send_channels) ? $fax_send_channels : null;
